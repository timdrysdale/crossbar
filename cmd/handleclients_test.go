...
func TestHandler(t *testing.T) {
	...
	client1 := clientDetails{"client1", "topic1", make(chan message)}
	client2 := clientDetails{"client2", "topic2", make(chan message)}
	client3 := clientDetails{"client3", "topic2", make(chan message)}
	client4 := clientDetails{"client4", "topic2", make(chan message)}
