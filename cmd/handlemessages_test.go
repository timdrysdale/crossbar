...
func TestHandleMessages(t *testing.T) {
	...
	//make test messages
	b1 := []byte{'c', 'r', 'o', 's', 's'}
	var testMessage1 = message{sender: client1, typ: websocket.BinaryMessage, data: b1}
	b2 := []byte{'b', 'a', 'r'}
	var testMessage2 = message{sender: client3, typ: websocket.BinaryMessage, data: b2}
	...
	b3 := []byte{'f', 'o', 'o'}
	var testMessage3 = message{sender: client2, typ: websocket.BinaryMessage, data: b2}
